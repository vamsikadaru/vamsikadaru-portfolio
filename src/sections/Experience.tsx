                ...
                <div className="space-y-16">
                    {experience.map((job, index) => (
                        <div key={index} className="flex flex-col md:flex-row gap-6 md:gap-12">
                            ...
                            {/* Right Column: Logo, Job Role, Company, Location, Description & Tech wrapped in SpotlightCard */}
                            <SpotlightCard className="flex-grow bg-white/[0.01] dark:bg-neutral-900/10 border-white/[0.05] hover:border-white/[0.1] transition-all">
                                <CardContent className="p-6">
                                    ...
                                    {job.tech && job.tech.length > 0 && (
                                        <div className="flex flex-wrap gap-x-6 gap-y-2.5 items-center text-sm font-medium text-muted-foreground/80 font-sans">
                                            {/* @ts-ignore */}
                                            {job.tech.map((t, i) => (
